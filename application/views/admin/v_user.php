		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
							<a href="<?= base_url()?>admin/user/add" class="btn btn-primary"><i class="bx bx-plus"></i> Add User</a>
							...
							<table id="example" class="table table-striped table-bordered text-center" style="width:100%">
								...
								<tbody>
									...
									<tr>
										...
										<td><?= $p->email?></td>
										<td><?= $p->role?></td>
										<td><img src="<?= base_url()?>uploads/user/<?= $p->foto?>" width="50px" alt=""></td>
										<td><a href="<?= base_url()?>admin/user/edit/<?= $p->id?>"><i class="bx bxs-edit"></i></a> &nbsp <a href="#hapus<?= $p->id?>"  data-bs-toggle="modal" data-bs-target="#hapus<?= $p->id?>"><i class="bx bxs-trash"></i></a></td>
									</tr>
									<?php }?>
								</tbody>
							</table>
											...
											<div class="modal-dialog modal-lg modal-dialog-centered">
												<div class="modal-content bg-danger">
													...
													<div class="modal-footer">
														...
														<form action="<?= base_url()?>admin/user/delete/<?= $p->id?>">
